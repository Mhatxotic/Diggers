...
Diggers is a puzzle/strategy game originally released for the Amiga CD32 (bundled with Oscar) and later ported to the Amiga 1200 and DOS. Set on the mineral rich planet Zarg, the game combines resource management, real-time strategy, and emergent unit behavior as players command mining crews to extract gems and ores while racing AI opponents. A sequel, Diggers 2: Extractors, was released for DOS in 1995.

Amiga versions emphasised hand-drawn pixel art, distinctive chiptune/AmigaTracker music, and platform-optimised input. The DOS release adapted graphics and sound to PC hardware of the era and added compatibility for VGA and Sound Blaster cards where supported. Performance considerations (pathfinding, particle effects, and real-time collision) were implemented with memory and CPU-efficient routines appropriate for 1990s hardware, giving the game a crisp, responsive feel on both Amiga and contemporary PCs.

* **Objective:** Select one of four races and deploy a five-miner team to mine 34 distinct regions. Each region has a monetary target that must be reached to unlock adjacent territories; two regions are available at the start.
* **Playable Races:** Each race has unique animations, audio cues, and behavioral quirks that affect tactics…
  - **Habbish:** Fast diggers with high endurance but prone to drifting from orders.
  - **Grablins:** Fastest diggers, good stamina, weaker in combat.
  - **Quarriors:** Slow diggers but strong fighters and durable.
  - **F'Targs:** Average diggers and fighters who recover health rapidly.
* **Controls & View:** Side-on, profile view of branching mineshafts and caves. Players issue high-level orders (dig, pick up, fight, use tool) rather than direct micro-control—gameplay resembles [Lemmings](https://en.wikipedia.org/wiki/Lemmings_(video_game)) but emphasises economy and stock market timing.
* **Resources & Loot:** As miners excavate, they uncover rubies, gold, emeralds, diamonds and other mysterious objects and entities. Environmental hazards include water, lava, traps, and hostile wildlife; terrain and object collisions are physics-informed for the era.
* **Economy & Market:** The Zargon Stock Exchange lets players teleport miners back to sell finds. Only three commodities trade at a time; prices fluctuate based on recent transactions and supply, rewarding timing and hoarding strategies. Balancing between holding high-value gems and selling to meet region goals is a core strategic layer.
* **Equipment & Upgrades:** The in-game shop sells expendables and tools including dynamite, automated drillers, bridging components, and defensive items. Using items effectively (for example, timed dynamite to open rich veins) is essential for higher-difficulty regions.
* **AI & Emergent Behaviour:** Rival AI races actively mine the same region and use similar tools; they can contest tunnels, steal gems, and engage in combat. Miner personalities can produce beneficial autonomous actions (defending, opportunistic digging) or catastrophic mistakes (wandering into hazards, drowning). This unpredictability drives replayability and tactical adaptation.
* **Difficulty & Progression:** Regions vary in geology, hazard density, and market dynamics. Later levels introduce denser ore veins, rarer gems, and more aggressive AI strategies. Time pressure plus opponent actions forces efficient use of miners and items.

This modern version originated in 2006 as a [Win32 C build](https://github.com/Mhatxotic/Diggers/releases/tag/Diggers-R00) (DirectDraw, DirectSound and DirectMedia) but was rewritten from scratch in modern C++ with the versatile Mhatxotic Engine to use open-source, cross-platform libraries and follow ISO coding standards. Enhancements to original mechanics, level designs, and game balance while modernising rendering, audio, input handling, and build systems. Also including configurable controls, higher-resolution assets where available, cross-platform input/backends, and improved compatibility for modern displays and sound hardware. Playable from start to finish. Active, single-developer maintenance continues; efforts focus on modernization, bug fixes, balancing, and upstream dependency compatibility.
