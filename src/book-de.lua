...
local aBookData<const> = {
  ...
  { T="DAS BUCH VON ZARG\n\z
    ...
    Zarg und ist unerläßlich für alle, die auf dem Planeten Berobau \z
    betreiben möchten. Anhand der Kapiteluerschritten sino ole intormattonen \z
    rasch zugänglich. Um die gewünschte Auskunft zu erhalten, klicken Sie \z
    einfach auf die betreffende Kapitelüberschrift, und der gewählte \z
    Bildschirm wird eingeblendet. Am linken Rand des Buches befindet sich \z
    eine Tastenreihe, mit der Sie einen beliebigen Bildschirm ultriten monen"
  -- Page 2 ---------------------------------------------------------------- --
    ...
    H={ { 77,  51, 224, 7,  3 },     -- Chapter 01/11: About this book
        { 77,  62, 224, 7,  7 },     -- Chapter 02/11: How to start Diggers
        { 77,  73, 224, 7, 16 },     -- Chapter 03/11: The Planet Zarg
        { 77,  84, 224, 7, 19 },     -- Chapter 04/11: Race descriptions
        { 77,  95, 224, 7, 33 },     -- Chapter 05/11: Zone descriptions
        { 77, 106, 224, 7, 37 },     -- Chapter 06/11: Flora and fauna
        { 77, 117, 224, 7, 55 },     -- Chapter 07/11: The mining store
        { 77, 128, 224, 7, 57 },     -- Chapter 08/11: Mining apparatus
        { 77, 139, 224, 7, 71 },     -- Chapter 09/11: Zargon bank
        { 77, 150, 224, 7, 75 },     -- Chapter 10/11: Zargon stock market
        { 77, 161, 224, 7, 78 } }    -- Chatper 11/11: Zargon mining history
  -- Page 3 ---------------------------------------------------------------- --
  },{ T="ZU DIESEM BUCH\n\z
    \n\z
    Die Benutzung des Buches von Zarg ist ganz einfach. Das Poch beent sich \z
    emen smermoocrach Stosta namens TNT, um seine Seiten anzuzeigen \z
    (s. TNT). Das Buch braucht daher nur das Deckblatt, ein Blatt TNT und \z
    den Steuerungsmechanismus für TNT (drei eschliffene Smaragde im \z
    Buchrücken) zu enthalten.\n\z
    Mit dem obersten Smaragd wird der Leser zur anoexsete zuruckoebracht.\n\z
    Mit dem zweiten Smaragd wird der Leser auf die nachste selte oebracht.\n\z
    Mit dem dritten Smaragd wird der Leser auf die vornerloe sele \z
    zuruckoebracht."
  -- Page 4 ---------------------------------------------------------------- --
  },{ T="Durch einen einfachen Druck auf die betreffende Taste oeranot oer \z
    Leser aut ole oewunschte selte Um ein Kapitel auszuwählen, auf die \z
    überschrift des gewünschten Kapitels zeigen. Der Leser wird daderch \z
  ...
  -- Page 5 ---------------------------------------------------------------- --
  },{ T="knisternden Intellekte\" auf dem Planeten Cerebralis bewonnen, es \z
    vollstanolo verstenen konnen. wir woller daher eine Erklärung erst gar \z
    nicht versuchen. Beschränken wir uns auf die Aussage, daß TNT eine \z
    beeindruckende, manche würden sogar sagen revolutionäre yooch naturlich \z
    tinoen sich Immer ein paar zu solchen Aussagen bereite Leute - \z
    normalerweise mit verdächtigem Haarwuchs im Gesicht und einer schlecht \z
    aufgenommenen Demo-Kassette in der Tasche) Wirkung ant alo Eeton mon \z
    Richocn hat.\n\z
    \n\z
  ...
  -- Page 9 ---------------------------------------------------------------- --
    ...
    DIE BANK\n\z
    \n\z
    Die linke Tür auf dem Flur des Handelszentrums von Zaro. Den \z
  ...
  -- Page 11 --------------------------------------------------------------- --
    ...
    Wählen Sie den Ablagekorb, um de entsprechenden Optionen aurzurufen."
  -- Page 12 --------------------------------------------------------------- --
  },{ T="STEUERSYMBOLE\n\z
    \n\z
    \n\z
  ...
  -- Page 17 --------------------------------------------------------------- --
  },{ T="Fine weitere Gefahr für die Arbeiter stellten die Kämpfe zwischen \z
  ...
  -- Page 22 --------------------------------------------------------------- --
    ...
    mit niedrigen Decken acheiten. Obschon sie stark sind, ist ihre \z
  ...
  -- Page 28 --------------------------------------------------------------- --
    ...
    anderen. Das Graben macht Innen spaß, doch sie lassen sich leicht durch \z
  ...
  -- Page 29 --------------------------------------------------------------- --
  },{ T="Der sehnlichste Wunsch der F'Targs ist es, genügend Geld anzuhäufen, um \z
    ihr geplantes Museum der metallenen Meisterwerke (dem eine bösartige \z
    Seele den unfreundlichen Spitznamen \"Schrotthaufen\" verlieh) zu bauen. \z
    Darin wollen sie zeitlosen Schrott und besonders interessante \z
    Blechskulpturen ausstellen."
  -- Page 30 --------------------------------------------------------------- --
  },{ T="DIE FLIMMERER:\n\z
    \n\z
    ...
    weltlichen Besitztümer verzichteten und thre Güter auf den Schaltertisch \z
  ...
  -- Page 31 --------------------------------------------------------------- --
    ...
    sich in alten Schatzoräberlegenden erzählt einige Leute hätten flüchtige \z
    Blicke auf schüchterne Wesen, die wie Flimmerer aussahen, erhascht. Die \z
    meisten dieser Geschichten wurden auf übermäßigen Grokkonsum \z
    zurückgeführt, doch das Gerücht bleibt weiterhin bestehen, daß irgenwo \z
    weit entfernt von hier in den Tiefen unterirdischen Höhlen des Planeten \z
    die Nachkommen dieser Schatzgräber ihr Dasein fristen.\n\z
  ...
  -- Page 37 --------------------------------------------------------------- --
    ...
    einer Reihe protessioneller Aufzeichnungen und Zeugenberichten \z
  ...
  -- Page 39 --------------------------------------------------------------- --
    ...
    Stärketrank und redeten wiederum schienen verwirrt und redeten \z
  ...
  -- Page 51 --------------------------------------------------------------- --
    ...
    ihre Geschichte erzählen konnten, sprachen won sich bewegenden, \z
  ...
  -- Page 52 --------------------------------------------------------------- --
  },{ T="In den Bars des Planeten wird erzählt, daß es sich dabei um de \z
  ...
  -- Page 60 --------------------------------------------------------------- --
    ...
    werden jedoch in Fünterpacks geliefert, wobei sich das angegebene \z
    ...
    mit dem Boden und können nicht mehr bewegt oder durchbohrt weden.",
    I={ 19, 196, 29 }
  -- Page 61 --------------------------------------------------------------- --
  ...
  -- Page 65 --------------------------------------------------------------- --
    ...
    bis er aut ein Hindernis auftrifft. In feuchten Gebieten sollte mit dem \z
  ...
  -- Page 67 --------------------------------------------------------------- --
    ...
    Gewicht: 4 Hechel.\n\z
    \n\z
    Alloemeine Informationen: VORSICHTP: Hochexplosiv! Unerläßliche \z
    Ausrüstung zum Sprengen von reisen oder zum Betreten der Minen des \z
  ...
  -- Page 77 --------------------------------------------------------------- --
    ...
    ein rosafarbener Edelstein, der sehr selten vorkommt uno daher \z
    ausgesprochen kostoar ist.\n\z
    \n\z
